...
function SettingsRow({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={[
        "w-full cursor-pointer rounded-xl border border-zinc-200 bg-zinc-100",
        "py-6 px-6",
          ...
          <div className="px-4 sm:px-6 pt-2">
            ...
            <div className="flex items-center rounded-xl border border-zinc-200 bg-zinc-100 px-3">
              ...
              <button
                type="button"
                onClick={() => setShow((s) => !s)}
                className="ml-2 cursor-pointer text-zinc-500 hover:text-zinc-700"
          ...
          <div className="px-4 pb-4 sm:px-6 pt-3">
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                disabled={submitting}
                className="w-full cursor-pointer rounded-xl bg-blue-600 px-4 py-3 text-sm font-medium text-white hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {submitting ? (
