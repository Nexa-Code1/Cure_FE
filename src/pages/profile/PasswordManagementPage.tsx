            ...
            <Form className="mt-4 space-y-5">
              ...
              <div>
                ...
                <div className="flex items-center rounded-xl border border-zinc-200 bg-zinc-100 px-3">
                  <Field
                    ...
                    className="w-full bg-transparent py-6 px-4 text-sm outline-none placeholder:text-zinc-400"
                  />
                  <button
                    type="button"
                    onClick={() => toggleVisibility("current")}
                    className="mr-4 cursor-pointer text-zinc-500 hover:text-zinc-700"
                  >
              ...
              <div>
                <button
                  ...
                  className="w-full cursor-pointer rounded-xl bg-blue-600 p-4 text-sm font-medium text-white shadow-md hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
